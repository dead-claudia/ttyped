...
function check(test, type, value) {
    if (!test) {
...
TypeChecker.prototype.check = function (type, value) {
    check(typeCheck.parsedTypeCheck(this.cache[type], value, this.types),
        type, value)
}

TypeChecker.prototype.test = function (type, value) {
    if (typeof type !== "string") {
    ...
    return !!typeCheck.parsedTypeCheck(cached, value, this.types)
}

TypeChecker.prototype.checkCached = function (type, value) {
    return check(this.test(type, value), type, value)
}
